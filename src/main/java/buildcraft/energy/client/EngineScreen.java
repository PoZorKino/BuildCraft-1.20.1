...
/** GUI shared by the fuel-burning engines. Rendered with primitives, so it needs no atlas texture. */
public class EngineScreen extends AbstractContainerScreen<EngineMenu> {
    ...
    public EngineScreen(EngineMenu menu, Inventory inv, Component title) {
    ...
    protected void renderBg(GuiGraphics g, float partialTick, int mouseX, int mouseY) {
        ...
        int color = STAGE_COLORS[stageFor(menu.getEnergy(), menu.getMaxEnergy())];
        if (fill > 0) {
