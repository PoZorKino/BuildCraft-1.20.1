...
public class AssemblyMenu extends AbstractContainerMenu {
    ...
    public AssemblyMenu(int id, Inventory playerInv, FriendlyByteBuf buf) {
        this(id, playerInv, new ItemStackHandler(2), new SimpleContainerData(4), buf.readBlockPos());
    }

    public AssemblyMenu(int id, Inventory playerInv, IItemHandler inv, ContainerData data, BlockPos pos) {
        super(BCMenuTypes.ASSEMBLY_TABLE.get(), id);
        this.data = data;
        this.pos = pos;
    ...
    public int getProgressScaled(int width) {
        ...
        return Math.min(width, data.get(2) * width / cost);
    }
